...
class FrontEnd(object):
    ...
    #    if self.out_info[0] < 20 or self.out_info[1] < 20:
    #         self.state = 4
    #    if self.state = 4:
    ...
    #    print ("self.out_info",self.out_info)
    ...
    def keydown(self, key):
        ...
        if key == pygame.K_UP:  # set forward velocity
            ...
            self.yaw_velocity = S
        elif key == pygame.K_z:  # set yaw clockwise velocity
            self.state = 1
            ...
            if self.out_info[3] < -20:
                self.yaw_velocity = -S
                print  ("sssssssssssssssssssssssss")
            if self.out_info[3] >-5:
                self.yaw_velocity = S
                print ("---------------------sssssssss")
            else :
                self.yaw_velocity = 0
