...
if __name__ == '__main__':
    ...
    #     print("INFO:m_aruco_x=={0}",self.m_aruco_x)
    #     print("INFO:m_aruco_y=={0}",self.m_aruco_y)
    #     print("INFO:m_aruco_z=={0}",self.m_aruco_z)

    #     print("INFO:m_aruco_rx=={0}",self.m_aruco_rx)
    #     print("INFO:m_aruco_ry=={0}",self.m_aruco_ry)
    #     print("INFO:m_aruco_rz=={0}",self.m_aruco_rz)

    #     print("INFO:m_frame_center_x=={0}",self.m_frame_center_x)
    #     print("INFO:m_frame_center_y=={0}",self.m_frame_center_y)
    #     print("INFO:m_arcuo_center_x=={0}",self.m_arcuo_center_x)
    #     print("INFO:m_arcuo_center_y=={0}",self.m_arcuo_center_y)

    #     print("INFO:m_arcuo2frame_center_distance=={0}",self.m_arcuo2frame_center_distance)
